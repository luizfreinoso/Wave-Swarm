...
IL_0026:
	{
		Vector4__ctor_m1222289168((&V_2), (50.0f), (50.0f), (100.0f), (100.0f), /*hidden argument*/NULL);
		V_3 = (1.0f);
		float L_7 = Time_get_time_m2216684562(NULL /*static, unused*/, /*hidden argument*/NULL);
		V_4 = ((float)((float)L_7/(float)(20.0f)));
		Vector4_t2243707581  L_8 = V_2;
		float L_9 = V_4;
		float L_10 = V_3;
		Vector4_t2243707581  L_11 = Vector4_op_Multiply_m3204903356(NULL /*static, unused*/, L_8, ((float)((float)L_9*(float)L_10)), /*hidden argument*/NULL);
		V_5 = L_11;
		float L_12 = (&V_5)->get_x_1();
		IL2CPP_RUNTIME_CLASS_INIT(Mathf_t2336485820_il2cpp_TypeInfo_var);
		float L_13 = Mathf_Repeat_m943844734(NULL /*static, unused*/, L_12, (1.0f), /*hidden argument*/NULL);
		float L_14 = (&V_5)->get_y_2();
		float L_15 = Mathf_Repeat_m943844734(NULL /*static, unused*/, L_14, (1.0f), /*hidden argument*/NULL);
		float L_16 = (&V_5)->get_z_3();
		float L_17 = Mathf_Repeat_m943844734(NULL /*static, unused*/, L_16, (1.0f), /*hidden argument*/NULL);
		float L_18 = (&V_5)->get_w_4();
		float L_19 = Mathf_Repeat_m943844734(NULL /*static, unused*/, L_18, (1.0f), /*hidden argument*/NULL);
		Vector4__ctor_m1222289168((&V_6), L_13, L_15, L_17, L_19, /*hidden argument*/NULL);
		Material_t193706927 * L_20 = V_1;
		Vector4_t2243707581  L_21 = V_6;
		Material_SetVector_m3298399397(L_20, _stringLiteral3749796871, L_21, /*hidden argument*/NULL);
		return;
	}
}
